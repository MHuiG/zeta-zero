...
- 尼可尔·奥里斯姆 (Nicole Oresme) 证明调和级数发散，但知道的人不多。17世纪时，皮耶特罗·曼戈里(Pietro Mengoli)、约翰·伯努利(Johann Bernoulli)和雅各布·伯努利(Jakob I. Bernoulli)完成了全部证明工作。
...
- 高斯 (Gauss) 经过深入分析和例证，对素数分布提出猜测: $\pi(x)\sim\int_{2}^{x}\frac{du}{lnu}$ , $\pi(x)\sim\frac{x}{lnx}$ (素数定理).但高斯未将自己的猜测公诸于世.
...
- 欧德里兹科 (Odlyzko) 和肖恩哈格 (Schonhage) 提出用于评估多点上黎曼 $\zeta$ 函数值的快速算法：欧德里兹科-肖恩哈格算法. [...](https://www.ams.org/journals/tran/1988-309-02/S0002-9947-1988-0961614-2/S0002-9947-1988-0961614-2.pdf)
...
- 美国克雷数学研究所为包括黎曼猜想在内的七个 “千禧年问题” 设立了每个一百万美元的巨奖。[...](https://www.claymath.org/millennium/riemann-hypothesis/)
